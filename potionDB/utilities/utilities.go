...
func FancyDebugPrint(src string, replicaID uint16, msgs ...interface{}) {
...
func FancyInfoPrint(src string, replicaID uint16, msgs ...interface{}) {
	if !allOutputDisabled {
...
func FancyWarnPrint(src string, replicaID uint16, msgs ...interface{}) {
	if !allOutputDisabled {
...
func FancyErrPrint(src string, replicaID uint16, msgs ...interface{}) {
	//if !allOutputDisabled {
	fancyPrint(ERROR, src, replicaID, msgs)
	//}
}

func fancyPrint(typeMsg string, src string, replicaID uint16, msgs []interface{}) {
