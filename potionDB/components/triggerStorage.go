...
type TriggerDB struct {
	Mapping             map[crdt.KeyParams][]AutoUpdate
...
func (m MatchableKeyParams) Match(keyP crdt.KeyParams) bool {
...
func InitializeTriggerDB() TriggerDB {
	return TriggerDB{Mapping: make(map[crdt.KeyParams][]AutoUpdate), GenericMapping: make(map[MatchableKeyParams][]AutoUpdate),
...
func (db TriggerDB) AddObject(params crdt.KeyParams) {
