...
func createProtoDownstreamUpds(upds []crdt.UpdateObjectParams) (protobufs []*proto.ProtoDownstreamUpd) {
...
func protoToPartitionUpds(protobuf *proto.ProtoNewRemoteTxn) (upds []crdt.UpdateObjectParams, partID int64) {
...
func protoToDownstreamUpds(protobufs []*proto.ProtoDownstreamUpd) (upds []crdt.UpdateObjectParams) {
	upds = make([]crdt.UpdateObjectParams, len(protobufs))
	for i, protobuf := range protobufs {
		keyProto := protobuf.GetKeyParams()
		upd := crdt.UpdateObjectParams{KeyParams: crdt.MakeKeyParams(string(keyProto.GetKey()), keyProto.GetType(), string(keyProto.GetBucket()))}
		//TODO: This should be downstream args
		upd.UpdateArgs = crdt.DownstreamProtoToAntidoteDownstream(protobuf.GetOp(), upd.CrdtType)
		upds[i] = upd
	}
	return upds
}
...
func apbBoundObjectToKeyParams(protobuf *proto.ApbBoundObject) (keyParams crdt.KeyParams) {
	return crdt.MakeKeyParams(string(protobuf.GetKey()), protobuf.GetType(), string(protobuf.GetBucket()))
}
