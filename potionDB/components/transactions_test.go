...
func TestWrites1(t *testing.T) {
	...
	firstKey := crdt.MakeKeyParams(string(fmt.Sprint(rand.Uint64())), proto.CRDTType_ORSET, "bkt")
	secondKey := crdt.MakeKeyParams(string(fmt.Sprint(rand.Uint64())), proto.CRDTType_ORSET, "bkt")
...
func TestWrites2(t *testing.T) {
	...
	firstKeyWrites := []crdt.UpdateObjectParams{firstWriteParams[0], thirdWriteParams[0]}
...
func TestNonStaticTransaction1(t *testing.T) {
	...
	txnRep := createAndProcessStartTxn(tm, txnPartitions, TransactionId(rand.Uint64()), clocksi.NewClockSiTimestampFromId(0))
	...
	readKeyParams := []crdt.ReadObjectParams{createReadObjParams(firstKey)}
...
func TestNonStaticTransaction2(t *testing.T) {
	...
	key := crdt.MakeKeyParams(string(fmt.Sprint(rand.Uint64())), proto.CRDTType_ORSET, "bkt")
	staticTxnWriteParams, staticTxnWriteReply := createAndProcessWrite(tm, txnPartitions, static, key, createRandomSetAdd, TransactionId(rand.Uint64()), clocksi.NewClockSiTimestampFromId(0))
	...
	readParams := []crdt.ReadObjectParams{createReadObjParams(key)}
	firstTxnReadReply := createAndProccessRead(tm, nonStatic, readParams, firstTxnRep.TransactionId, firstTxnRep.Timestamp)

	readExpectedUpds := []crdt.UpdateObjectParams{staticTxnWriteParams[0], firstTxnWriteParams[0]}
...
func TestReplicator1(t *testing.T) {
	...
	key := crdt.MakeKeyParams(string(fmt.Sprint(rand.Uint64())), proto.CRDTType_ORSET, "bkt")
	writeReq, writeReply := createAndProcessWrite(tm1, nil, static, key, createRandomSetAdd, TransactionId(rand.Uint64()), clocksi.NewClockSiTimestampFromId(0))
...
func TestReplicator2(t *testing.T) {
	...
	appliedWriteParams := make([]crdt.UpdateObjectParams, 2)
...
func createStaticRead(txnId TransactionId, ts clocksi.Timestamp, readParams []crdt.ReadObjectParams) (request TransactionManagerRequest, replyChan chan TMStaticReadReply) {
...
func createWrite(txnId TransactionId, ts clocksi.Timestamp, updParams []crdt.UpdateObjectParams) (request TransactionManagerRequest, replyChan chan TMUpdateReply) {
...
func createRead(txnId TransactionId, ts clocksi.Timestamp, readParams []crdt.ReadObjectParams) (request TransactionManagerRequest, replyChan chan []crdt.State) {
...
func createRandomSetAdd(keyParams crdt.KeyParams) (writeParams []crdt.UpdateObjectParams) {
	return []crdt.UpdateObjectParams{{KeyParams: keyParams, UpdateArgs: crdt.Add{Element: crdt.Element(string(fmt.Sprint(rand.Uint64())))}}}
}

func createReadObjParams(keyParams crdt.KeyParams) (readParams crdt.ReadObjectParams) {
	return crdt.ReadObjectParams{KeyParams: keyParams, ReadArgs: crdt.StateReadArguments{}}
}
