...
type Replicator struct {
	...
	txnCache map[int][]PairClockUpdates //int: partitionID	//TODO: This should be changed to [][]PairClockUpdates
...
func (repl *Replicator) replicateCycle() {
	...
	for {
		...
		//ignore(previousLen)
		//ignore(toSend)*/
		//ignore(count, start, finish, toSleep, previousLen)
	}
}
