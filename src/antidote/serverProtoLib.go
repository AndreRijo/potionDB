...
func CreateBCPermissionsReqProto(perms []map[KeyParams]int32, reqReplicaID int16) *proto.ProtoBCPermissionsReq {
...
func CreateBCPermissionsPartReqProto(partPerms map[KeyParams]int32) *proto.ProtoBCPermissionsPartReq {
...
func CreateBCPermissionsPairProto(key KeyParams, value int32) *proto.ProtoBCPermissionsPair {
...
func ProtoBCPermissionsReqToTM(protobuf *proto.ProtoBCPermissionsReq) TMBCPermsArgs {
	...
	perms := make([]map[KeyParams]int32, len(partProtos))
	for i, partP := range partProtos {
		pairProtos = partP.GetPairs()
		perms[i] = make(map[KeyParams]int32)
